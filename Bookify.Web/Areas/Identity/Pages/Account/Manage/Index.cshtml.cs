...
namespace Bookify.Web.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Phone]
            [Display(Name = "Phone number"), MaxLength(11), RegularExpression(RegexPatterns.MobileNumber,ErrorMessage = Errors.InvalidMobileNumber)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                _iImageService.DeleteImage($"/Images/Users/{user.Id}.png");

                var (isUploaded, errorMessage) = await _iImageService.UploadAsync(Input.Avatar, $"{user.Id}.png", "/Images/Users", hasThumbNail: false);
                if (!isUploaded)
                {
